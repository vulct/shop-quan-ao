    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Thêm Mới</strong> Sản Phẩm</h2> <p>(Vui lòng điền đầy đủ vào phần có dấu <span class="text-danger">*</span>)</p>
                    ...
                    <div class="body">
                        <form id="form_add_product" method="POST" enctype="multipart/form-data" class="basic-repeater" onsubmit="return false">
                            <div class="row clearfix" >
                                <div class="col-md-12 m-t-10">
                                    <label for="name_product"><b>Tên Sản Phẩm <span class="text-danger">*</span></b></label>
                                    <div class="form-group">
                                        <input type="text" id="name_product" name="name_product" class="form-control" placeholder="Tên sản phẩm">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix" >
                                <div class="col-md-6 m-t-10">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="price_product" id="price_product" class="form-control" placeholder="Giá sản phẩm. Ex: 99,99 $">
                                    </div>
                                </div>
                                <div class="col-md-6 m-t-10">
                                    <label for="discount_product"><b>Giảm Giá(Dollar)</b></label>
                                    <div class="form-group">
                                        <input type="text" name="discount_product" id="discount_product" class="form-control money-dollar" placeholder="Giá sản phẩm sau khi giảm giá. Ex: 99,99 $">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix" >
                                <div class="col-md-3 m-t-10">
                                    <label for="inputGroupFile01"><b>Ảnh Sản Phẩm<span class="text-danger">*</span></b></label>
                                        ...
                                        <div data-repeater-item="">
                                            <div class="row">
                                                <div class="col-md-2 col-sm-12 form-group">
                                                    ...
                                                    <input type="number" min="0" class="form-control" name="group-a[0][quantity_product]" placeholder="Nhập số lượng">
                                                </div>
                                                <div class="col-md-2 col-sm-12 form-group" >
                                                    ...
                                                    <select name="group-a[0][color_product]" class="form-control">
                                                        ...
                                                        <?php foreach ($dataViews['color'] as $color){?>
                                                            <option class="color-product" style='background-color: <?=$color['coCode']?>' value="<?=$color['coID']?>"><?=$color['coColor']?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-2 col-sm-12 form-group">
                            ...
                            <div class="row clearfix" >
                                <div class="col-lg-12 col-md-12 col-sm-12 m-t-10">
                                    ...
                                    <textarea id="description_product" class="form-control" placeholder="Here can be your nice text" name="description_product" rows="10"></textarea>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-3 m-t-10">
                                    <div class="checkbox">
                                        <input id="checkbox2" type="checkbox" checked="" name="show_product">
                                        <label for="checkbox2">
                                            Hiển thị sản phẩm
                                        </label>
                                    </div>
                            ...
                            <button class="btn btn-raised btn-primary btn-round waves-effect" data-text-alert="" id="add-product" type="submit">THÊM SẢN PHẨM</button>
                        </form>
                    </div>
                </div>
            </div>
